...
import { HandPlatter, Loader2, Menu, Moon, PackageCheck, ShoppingCart, ShoppingCartIcon, SquareMenu, Sun, User, UtensilsCrossed } from 'lucide-react';
                ...
                <div className="hidden md:flex items-center gap-10">
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <Link to="/cart" className='relative cursor-pointer'>
                            <ShoppingCart />
                            <Button size={'icon'} className="absolute -inset-y-3 left-4 text-sm rounded-full h-4 w-4 bg-red-500 hover:bg-red-600">{cart.length}</Button>
                        </Link>
                        <div>
                            <Avatar>
            ...
            <SheetContent className="flex flex-col">
                ...
                <SheetFooter className="flex flex-col gap-4">
                    <div className='flex flex-row items-center gap-2'>
                        ...
                        <h1 className='font-bold'>Fork&Feast</h1>
                    </div>
                    <SheetClose asChild>
                            {
                                loading ? (<Button disabled className="bg-orange hover:bg-hoverOrange">
                                    ...
                                    (
                                        <Button onClick={logout} type="submit" className="bg-orange hover:bg-hoverOrange">Logout</Button>
                                    )
                            }
