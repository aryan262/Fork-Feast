...
function Signup() {
    ...
    const { signup, formLoading } = useUserStore();
    ...
    return (
        <div className='flex items-center justify-center min-h-screen'>
            <form onSubmit={signupSubmitHandler} className='md:p-8 w-full max-w-md md:border border-gray-200 rounded-lg'>
                <div className='mb-4'>
                ...
                <div className="mb-4">
                    <div className='relative'>
                        <Input type='text' placeholder='Phone Number' name='contact' value={input.contact} onChange={changeEventHandler} className="pl-10 focus-visible:ring-1" />
